package com.exprnc.presentation.emaildetails.mvi

import com.exprnc.coreui.mvi.MVIContract
import com.exprnc.domain.model.emaildetails.EmailDetailsModel

interface EmailDetailsContract : MVIContract<EmailDetailsContract.UIState, EmailDetailsContract.EmailDetailsEffect, EmailDetailsContract.EmailDetailsEvent> {
    data class UIState(
